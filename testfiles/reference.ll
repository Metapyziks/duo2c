...
@.str = private unnamed_addr constant [9 x i8] c"SDL2.dll\00", align 1
@.str1 = private unnamed_addr constant [25 x i8] c"Could not load library!\0A\00", align 1
@.str2 = private unnamed_addr constant [9 x i8] c"SDL_Init\00", align 1
@.str3 = private unnamed_addr constant [13 x i8] c"SDL_GetError\00", align 1
@.str4 = private unnamed_addr constant [9 x i8] c"SDL_Quit\00", align 1
@.str5 = private unnamed_addr constant [27 x i8] c"Could not find procedure!\0A\00", align 1
...
define i32 @main() nounwind {
  ...
  store i32 0, i32* %1
  %2 = call x86_stdcallcc %struct.HINSTANCE__* @LoadLibraryA(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0))
...
; <label>:5                                       ; preds = %0
  %6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0)) nounwind
  call void @exit(i32 1) noreturn nounwind
  unreachable

; <label>:7                                       ; preds = %0
  %8 = load %struct.HINSTANCE__** %sdl, align 4
  %9 = call x86_stdcallcc i32 (...)* (%struct.HINSTANCE__*, i8*)* @GetProcAddress(%struct.HINSTANCE__* %8, i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0))
  store i32 (...)* %9, i32 (...)** %init, align 4
  %10 = load %struct.HINSTANCE__** %sdl, align 4
  %11 = call x86_stdcallcc i32 (...)* (%struct.HINSTANCE__*, i8*)* @GetProcAddress(%struct.HINSTANCE__* %10, i8* getelementptr inbounds ([13 x i8]* @.str3, i32 0, i32 0))
  store i32 (...)* %11, i32 (...)** %getError, align 4
  %12 = load %struct.HINSTANCE__** %sdl, align 4
  %13 = call x86_stdcallcc i32 (...)* (%struct.HINSTANCE__*, i8*)* @GetProcAddress(%struct.HINSTANCE__* %12, i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0))
...
; <label>:22                                      ; preds = %19, %16, %7
  %23 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([27 x i8]* @.str5, i32 0, i32 0)) nounwind
  call void @exit(i32 1) noreturn nounwind
  unreachable
...
; <label>:34                                      ; preds = %24
  ...
  %36 = call i8* %35()
  %37 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([24 x i8]* @.str6, i32 0, i32 0), i8* %36) nounwind
  call void @exit(i32 1) noreturn nounwind
  unreachable

; <label>:38                                      ; preds = %24
  store i32 1, i32* @sdl_initialized, align 4
  %39 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([16 x i8]* @.str7, i32 0, i32 0)) nounwind
